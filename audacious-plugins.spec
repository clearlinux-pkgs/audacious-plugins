...
%prep
%setup -q -n audacious-plugins-4.4.2
cd %{_builddir}/audacious-plugins-4.4.2
pushd ..
cp -a audacious-plugins-4.4.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1739345864
...
export GOAMD64=v2
meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dneon=false \
-Dffaudio=false  builddir
ninja -v -C builddir
GOAMD64=v3
CFLAGS="$CFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " CXXFLAGS="$CXXFLAGS -march=x86-64-v3 -Wl,-z,x86-64-v3 " LDFLAGS="$LDFLAGS -march=x86-64-v3 " meson --libdir=lib64 --prefix=/usr --buildtype=plain -Dneon=false \
-Dffaudio=false  builddiravx2
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/audacious/Container/asx.so
/V3/usr/lib64/audacious/Container/asx3.so
/V3/usr/lib64/audacious/Container/audpl.so
/V3/usr/lib64/audacious/Container/m3u.so
/V3/usr/lib64/audacious/Container/pls.so
/V3/usr/lib64/audacious/Container/xspf.so
/V3/usr/lib64/audacious/Effect/background_music.so
/V3/usr/lib64/audacious/Effect/bitcrusher.so
/V3/usr/lib64/audacious/Effect/compressor.so
/V3/usr/lib64/audacious/Effect/crossfade.so
/V3/usr/lib64/audacious/Effect/crystalizer.so
/V3/usr/lib64/audacious/Effect/echo.so
/V3/usr/lib64/audacious/Effect/ladspa.so
/V3/usr/lib64/audacious/Effect/mixer.so
/V3/usr/lib64/audacious/Effect/resample.so
/V3/usr/lib64/audacious/Effect/silence-removal.so
/V3/usr/lib64/audacious/Effect/speed-pitch.so
/V3/usr/lib64/audacious/Effect/stereo.so
/V3/usr/lib64/audacious/Effect/voice_removal.so
/V3/usr/lib64/audacious/General/albumart-qt.so
/V3/usr/lib64/audacious/General/albumart.so
/V3/usr/lib64/audacious/General/aosd.so
/V3/usr/lib64/audacious/General/delete-files.so
/V3/usr/lib64/audacious/General/gtkui.so
/V3/usr/lib64/audacious/General/hotkey.so
/V3/usr/lib64/audacious/General/lyrics-gtk.so
/V3/usr/lib64/audacious/General/lyrics-qt.so
/V3/usr/lib64/audacious/General/mpris2.so
/V3/usr/lib64/audacious/General/notify.so
/V3/usr/lib64/audacious/General/playlist-manager-qt.so
/V3/usr/lib64/audacious/General/playlist-manager.so
/V3/usr/lib64/audacious/General/qthotkey.so
/V3/usr/lib64/audacious/General/qtui.so
/V3/usr/lib64/audacious/General/scrobbler.so
/V3/usr/lib64/audacious/General/search-tool-qt.so
/V3/usr/lib64/audacious/General/search-tool.so
/V3/usr/lib64/audacious/General/skins-qt.so
/V3/usr/lib64/audacious/General/skins.so
/V3/usr/lib64/audacious/General/song-info-qt.so
/V3/usr/lib64/audacious/General/song_change.so
/V3/usr/lib64/audacious/General/statusicon-qt.so
/V3/usr/lib64/audacious/General/statusicon.so
/V3/usr/lib64/audacious/Input/amidi-plug.so
/V3/usr/lib64/audacious/Input/console.so
/V3/usr/lib64/audacious/Input/flacng.so
/V3/usr/lib64/audacious/Input/madplug.so
/V3/usr/lib64/audacious/Input/metronom.so
/V3/usr/lib64/audacious/Input/modplug.so
/V3/usr/lib64/audacious/Input/opus.so
/V3/usr/lib64/audacious/Input/psf2.so
/V3/usr/lib64/audacious/Input/sndfile.so
/V3/usr/lib64/audacious/Input/tonegen.so
/V3/usr/lib64/audacious/Input/vorbis.so
/V3/usr/lib64/audacious/Input/vtx.so
/V3/usr/lib64/audacious/Input/wavpack.so
/V3/usr/lib64/audacious/Input/xsf.so
/V3/usr/lib64/audacious/Output/alsa.so
/V3/usr/lib64/audacious/Output/filewriter.so
/V3/usr/lib64/audacious/Output/jack-ng.so
/V3/usr/lib64/audacious/Output/oss4.so
/V3/usr/lib64/audacious/Output/pipewire.so
/V3/usr/lib64/audacious/Output/pulse_audio.so
/V3/usr/lib64/audacious/Output/sdlout.so
/V3/usr/lib64/audacious/Transport/gio.so
/V3/usr/lib64/audacious/Visualization/blur_scope-qt.so
/V3/usr/lib64/audacious/Visualization/blur_scope.so
/V3/usr/lib64/audacious/Visualization/cairo-spectrum.so
/V3/usr/lib64/audacious/Visualization/gl-spectrum-qt.so
/V3/usr/lib64/audacious/Visualization/gl-spectrum.so
/V3/usr/lib64/audacious/Visualization/qt-spectrum.so
/V3/usr/lib64/audacious/Visualization/vumeter-qt.so
...
/usr/lib64/audacious/Effect/background_music.so
...
/usr/lib64/audacious/General/lyrics-gtk.so
/usr/lib64/audacious/General/lyrics-qt.so
...
/usr/lib64/audacious/General/qthotkey.so
...
/usr/lib64/audacious/Input/opus.so
