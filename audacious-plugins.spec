...
Source0  : https://distfiles.audacious-media-player.org/audacious-plugins-4.0.5.tar.bz2
...
%prep
%setup -q -n audacious-plugins-4.0.5
cd %{_builddir}/audacious-plugins-4.0.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1604537678
...
cp %{_builddir}/audacious-plugins-4.0.5/COPYING %{buildroot}/usr/share/package-licenses/audacious-plugins/058bcaa71216cd5b7746964ef0779648d9125860
cp %{_builddir}/audacious-plugins-4.0.5/src/aosd/ghosd-license %{buildroot}/usr/share/package-licenses/audacious-plugins/fa2506ef781ada584042824cc343dfad55883a5a
cp %{_builddir}/audacious-plugins-4.0.5/src/psf/peops/License.txt %{buildroot}/usr/share/package-licenses/audacious-plugins/cb6fc634bdc848142aa51dec793f7068a5a5efad
cp %{_builddir}/audacious-plugins-4.0.5/src/psf/peops2/License.txt %{buildroot}/usr/share/package-licenses/audacious-plugins/317b721a1cbbba5e4678ebad188f1161fcb356d7
cp %{_builddir}/audacious-plugins-4.0.5/src/xsf/desmume/COPYING %{buildroot}/usr/share/package-licenses/audacious-plugins/68c94ffc34f8ad2d7bfae3f5a6b996409211c1b1
%make_install
